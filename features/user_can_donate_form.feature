Feature: User can donate via a form 
    ...
    Scenario: User can access the donation form to make a donation
        ...
        And I fill in "donations[amount]" field with "500"
        And I fill in "donations[firstname]" field with "Hanna"
        And I fill in "donations[lastname]" field with "Nyman"
        And I fill in "donations[email]" field with "hanna@tuna.se"
        And I fill in "donations[postalcode]" field with "123456"
